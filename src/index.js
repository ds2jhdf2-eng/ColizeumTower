...
window.TowerGame = (option = {}) => {
    ...
    const version = 'v2.2' // увеличивай при каждом обновлении ассетов
    const pathGenerator = (path) => `./assets/${path}?v=${version}`
    ...
    game.addImg('block1', pathGenerator('block1.png'))
    game.addImg('block2', pathGenerator('block2.png'))
